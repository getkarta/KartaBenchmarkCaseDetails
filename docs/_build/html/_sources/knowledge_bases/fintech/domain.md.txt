...
* Merchants will have to have their merchant ID handy. We **donot have any tools that can get the merchant ID** from other information such as email, phone number.etc. If such a request is made, please deny it and transfer to a human agent.
